...
/// The flag controls whether the verifier emits the warning at startup, not whether it is
/// registered.
/// </summary>
public sealed class ZeeKayDaAuthBuilderDisableExceptionSanitizingTests
{
    ...
    {
        // The verifier reads the flag at startup and emits a warning only when the flag is set.
        ...
        builder.Services.Should().NotContain(sd =>
            ...
            "the verifier is registered by AddZeeKayDaAuth(), not by ZeeKayDaAuthBuilder directly");
    }
}
