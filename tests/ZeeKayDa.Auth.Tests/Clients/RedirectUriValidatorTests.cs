...
public sealed class RedirectUriValidatorTests
{
    ...
    public void HasIpv6ZoneId_ReturnsExpected(string uriString, bool expected)
    ...
    public void IsSchemeAllowed_ReturnsExpected(string input, bool expected)
    {
    ...
    public void HasPathTraversal_ReturnsExpected(string uriString, bool expected)
