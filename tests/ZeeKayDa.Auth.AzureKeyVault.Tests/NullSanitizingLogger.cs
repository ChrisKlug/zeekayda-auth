...
/// assert on log output. Mirrors <c>ZeeKayDa.Auth.Tests.NullSanitizingLogger{T}</c> — duplicated
/// here rather than shared because internal types are not visible across test assemblies.
/// </summary>
