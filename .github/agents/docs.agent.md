---
name: docs
description: Technical documentation specialist for ZeeKayDa.Auth. Writes and maintains all user-facing documentation as Markdown files structured for a Jekyll static site. Documentation is required for every public-facing feature — this agent is involved in every PR that touches the public API or behaviour.
